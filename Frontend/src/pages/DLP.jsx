          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-400">
                Data Loss Prevention - Detect & Redact Sensitive Information
              </p>
            </div>
...
• Generate a sample API response with user details"
              ...
              <div className="bg-slate-800 border border-slate-700 rounded-lg p-6">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-lg font-semibold text-white">
                      LLM Response - Scan for Sensitive Data
                    </h3>
                  </div>
                ...
                <div className="bg-slate-900 border border-slate-600 rounded-lg p-4 mb-4">
                  ...
                  <p className="text-white font-mono text-sm whitespace-pre-wrap max-h-64 overflow-y-auto">
                    {llmResponse}
                  </p>
                </div>
            ...
            {scanResult && (
              <div className="space-y-6">
                {/* Result Summary */}
                <div
                  className={`border-2 rounded-lg p-6 ${getRiskColor(scanResult.risk_level)}`}
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm opacity-80 mt-1">
                          {scanResult.findings?.length || 0} finding(s) • Risk
                      ...
                      {scanResult.findings.map((finding, index) => (
                        ...
                        >
                          <div className="flex items-start justify-between mb-2">
                            <div className="flex items-center gap-2">
                              <div
                                className={`w-2 h-2 rounded-full ${getTypeColor(finding.type)}`}
                              ></div>
                            ...
                            <span
                              className={`px-2 py-1 rounded text-xs font-semibold ${getRiskColor(finding.severity)}`}
                            >
                              {finding.severity}
                            </span>
                          </div>
