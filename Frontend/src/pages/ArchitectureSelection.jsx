...
const ArchitectureSelection = () => {
    ...
    return (
        <div className="min-h-screen bg-[#060611] flex flex-col items-center justify-center relative overflow-hidden px-6 py-12">
            ...
            {/* Connect Agent Modal - CUSTOM DESIGN FOR AGENT */}
            {showAgentModal && (
                    ...
                    <div className="relative bg-[#0F111A] border border-slate-800 rounded-xl w-full max-w-3xl overflow-hidden shadow-[0_0_50px_rgba(0,0,0,0.5)] animate-in fade-in zoom-in duration-300">
                        ...
                        <div className="p-6 pb-0 flex items-center justify-between">
                            <div className="flex flex-col gap-2">
                                <span className="text-violet-500 font-bold text-[10px] tracking-widest uppercase">Step 2 of 3: Configuration</span>
                        ...
                        <div className="p-8 flex flex-col items-center text-left">
                            ...
                            {validationError && (
                                <div className="w-full bg-red-500/10 border border-red-500/30 rounded-lg p-3 text-[10px] text-red-500 font-bold flex items-start gap-3 animate-in slide-in-from-top-2 mb-4">
