    ...
    <nav className="sticky top-0 z-50 bg-[#020617]/80 backdrop-blur-xl border-b border-gray-800/50">
      <div className="flex items-center justify-between px-6 py-4 max-w-7xl mx-auto">
        ...
        <Link to="/" className="flex items-center gap-3 group">
          ...
          <span className="font-black text-2xl tracking-tight text-white">Guardian AI</span>
        </Link>

        {/* Nav Links */}
        <div className="hidden md:flex items-center gap-8 text-sm font-medium">
          <a href="#product" className="text-gray-400 hover:text-white transition">Product</a>
          <a href="#solutions" className="text-gray-400 hover:text-white transition">Solutions</a>
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-4">
            <Link to="/login" className="text-sm font-bold hover:text-white text-gray-300 transition">
              Log In
            </Link>
            <Link
              to="/register"
