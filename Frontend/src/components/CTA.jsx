      ...
      <div className="bg-blue-600 rounded-2xl p-12 md:p-16 text-center relative overflow-hidden">
        <div className="relative z-10 max-w-3xl mx-auto">
          ...
          <p className="text-blue-100 mb-8 text-lg">
            Join developers and security teams using Guardian AI to validate AI
            deployments before production.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link
              to="/dashboard"
              className="bg-white text-blue-900 font-bold px-8 py-3 rounded-md hover:bg-gray-100 transition"
            >
